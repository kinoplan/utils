...
import io.kinoplan.utils.implicits.java.time.InstantSyntax.syntaxInstantOps

class InstantSyntaxSpec extends AnyWordSpec {
  def setLocale(lang: String): Unit = Locale.setDefault(Locale.forLanguageTag(lang))

  TimeZone.setDefault(TimeZone.getTimeZone("Europe/Moscow"))

  val date: Instant = OffsetDateTime.parse("2022-06-07T16:06:54.786+01:00").toInstant
