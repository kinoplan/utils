...
object Dependencies {
  ...
  object Libraries {
    ...
    val jacksonModule                    = "com.fasterxml.jackson.module"  %% "jackson-module-scala"                   % "2.18.3"
    ...
    val micrometerRegistryPrometheus     = "io.micrometer"                  % "micrometer-registry-prometheus"         % "1.14.5"
    ...
    val openTelemetrySemconv             = "io.opentelemetry.semconv"       % "opentelemetry-semconv"                  % "1.30.0"
    ...
    val testContainersMongodb            = "org.testcontainers"             % "mongodb"                                % "1.20.6"   % Test
    ...
    val zioInteropCats                   = "dev.zio"                       %% "zio-interop-cats"                       % "23.1.0.4"
    val zioMetricsConnectorsMicrometer   = "dev.zio"                       %% "zio-metrics-connectors-micrometer"      % "2.3.1"
    val zioOpenTelemetry                 = "dev.zio"                       %% "zio-opentelemetry"                      % "3.1.2"
  }
