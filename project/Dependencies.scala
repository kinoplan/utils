...
object Dependencies {
  ...
  object Libraries {
    ...
    val zioPrelude              = Def.setting("dev.zio" %%% "zio-prelude" % "1.0.0-RC45")
    ...
    val jacksonModule                    = "com.fasterxml.jackson.module"  %% "jackson-module-scala"                   % "2.21.0"
    ...
    val redisson                         = "org.redisson"                   % "redisson"                               % "4.1.0"
