...
object Dependencies {
  ...
  object Libraries {
    ...
    val chimney                 = Def.setting("io.scalaland" %%% "chimney" % "1.10.0")
    ...
    val http4sDsl                        = "org.http4s"                    %% "http4s-dsl"                             % "0.23.34"
    val http4sServer                     = "org.http4s"                    %% "http4s-server"                          % "0.23.34"
    val jacksonModule                    = "com.fasterxml.jackson.module"  %% "jackson-module-scala"                   % "2.22.0"
    ...
    val micrometerRegistryPrometheus     = "io.micrometer"                  % "micrometer-registry-prometheus"         % "1.16.6"
    ...
    val openTelemetrySemconv             = "io.opentelemetry.semconv"       % "opentelemetry-semconv"                  % "1.42.0"
    ...
    val redisson                         = "org.redisson"                   % "redisson"                               % "4.6.1"
    ...
    val zioMetricsConnectorsMicrometer   = "dev.zio"                       %% "zio-metrics-connectors-micrometer"      % "2.5.6"
