...
object Dependencies {
  ...
  object Libraries {
    ...
    val http4sDsl                        = "org.http4s"                    %% "http4s-dsl"                             % "0.23.31"
    val http4sServer                     = "org.http4s"                    %% "http4s-server"                          % "0.23.31"
    ...
    val micrometerRegistryPrometheus     = "io.micrometer"                  % "micrometer-registry-prometheus"         % "1.15.4"
