...
object Dependencies {
  ...
  val mockitoScala            = "org.scalatestplus"          %% "mockito-3-4"                    % "3.2.10.0"
  ...
  val testcontainersScalatest = "com.dimafeng"               %% "testcontainers-scala-scalatest" % testcontainersV % IntegrationTest
  val testcontainersMongodb   = "com.dimafeng"               %% "testcontainers-scala-mongodb"   % testcontainersV % IntegrationTest
