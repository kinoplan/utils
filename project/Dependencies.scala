...
object Dependencies {
  ...
  val http4sDsl            = "org.http4s"                    %% "http4s-dsl"             % "0.23.20"
  val http4sServer         = "org.http4s"                    %% "http4s-server"          % "0.23.20"
  ...
  val redisson             = "org.redisson"                   % "redisson"               % "3.22.0"
  ...
  val zioInteropCats       = "dev.zio"                       %% "zio-interop-cats"       % "23.0.0.6"
