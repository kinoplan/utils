...
object Dependencies {
  ...
  object Libraries {
    ...
    val jacksonModule                    = "com.fasterxml.jackson.module"  %% "jackson-module-scala"                   % "2.19.2"
    ...
    val micrometerRegistryPrometheus     = "io.micrometer"                  % "micrometer-registry-prometheus"         % "1.15.3"
    ...
    val prometheusExporterHttpServer     = "io.prometheus"                  % "prometheus-metrics-exporter-httpserver" % "1.3.10"
    ...
    val redisson                         = "org.redisson"                   % "redisson"                               % "3.50.0"
    ...
    val testContainersScala              = "com.dimafeng"                  %% "testcontainers-scala"                   % "0.43.0"   % Test
    ...
    val zioMetricsConnectorsMicrometer   = "dev.zio"                       %% "zio-metrics-connectors-micrometer"      % "2.4.1"
    val zioOpenTelemetry                 = "dev.zio"                       %% "zio-opentelemetry"                      % "3.1.7"
  }
