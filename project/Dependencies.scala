...
object Dependencies {
  ...
  object Libraries {
    ...
    val chimney                 = Def.setting("io.scalaland" %%% "chimney" % "1.11.0")
    ...
    val zioJson                 = Def.setting("dev.zio" %%% "zio-json" % "1.0.0")
    ...
    val http4sDsl                        = "org.http4s"                    %% "http4s-dsl"                             % "0.23.37"
    val http4sServer                     = "org.http4s"                    %% "http4s-server"                          % "0.23.37"
    val jacksonModule                    = "com.fasterxml.jackson.module"  %% "jackson-module-scala"                   % "2.22.2"
    ...
    val micrometerRegistryPrometheus     = "io.micrometer"                  % "micrometer-registry-prometheus"         % "1.16.7"
    ...
    val openTelemetrySemconv             = "io.opentelemetry.semconv"       % "opentelemetry-semconv"                  % "1.43.0"
    ...
    val prometheusExporterHttpServer     = "io.prometheus"                  % "prometheus-metrics-exporter-httpserver" % "1.8.0"
    ...
    val zioMetricsConnectorsMicrometer   = "dev.zio"                       %% "zio-metrics-connectors-micrometer"      % "2.5.8"
