...
object Dependencies {
  ...
  object Libraries {
    ...
    val zioPrelude              = Def.setting("dev.zio" %%% "zio-prelude" % "1.0.0-RC35")
    ...
    val openTelemetrySemconvIncubating   = "io.opentelemetry.semconv"       % "opentelemetry-semconv-incubating"       % "1.29.0-alpha"
