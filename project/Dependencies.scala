...
object Dependencies {
  ...
  object Versions {
    ...
    val openTelemetryJavaagentV      = "2.11.0"
    val openTelemetryJavaagentAlphaV = "2.11.0-alpha"
  ...
  object Libraries {
    ...
    val chimney                 = Def.setting("io.scalaland" %%% "chimney" % "1.6.0")
    ...
    // A -> Z
    val googleAutoService                  = "com.google.auto.service"        % "auto-service"                           % "1.1.1"
    ...
    val openTelemetryJavaagent             = "io.opentelemetry.javaagent"     % "opentelemetry-javaagent"                % openTelemetryJavaagentV
    val openTelemetryJavaagentExtensionApi = "io.opentelemetry.javaagent"     % "opentelemetry-javaagent-extension-api"  % openTelemetryJavaagentAlphaV
    val openTelemetryJavaagentTesting      = "io.opentelemetry.javaagent"     % "opentelemetry-testing-common"           % openTelemetryJavaagentAlphaV % Test
    val openTelemetryJavaagentTestingAgent = "io.opentelemetry.javaagent"     % "opentelemetry-agent-for-testing"        % openTelemetryJavaagentAlphaV % Test
    ...
    val prometheusExporterHttpServer       = "io.prometheus"                  % "prometheus-metrics-exporter-httpserver" % "1.3.5"
    ...
    val zioOpenTelemetry                   = "dev.zio"                       %% "zio-opentelemetry"                      % "3.1.0"
  }
